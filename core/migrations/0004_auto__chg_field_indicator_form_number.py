...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Indicator.form_number'
        db.alter_column(u'core_indicator', 'form_number', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Indicator.form_number'
        db.alter_column(u'core_indicator', 'form_number', self.gf('django.db.models.fields.IntegerField')())
