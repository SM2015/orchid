...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.form_number'
        db.add_column(u'core_indicator', 'form_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.form_number'
        db.delete_column(u'core_indicator', 'form_number')
    ...
    models = {
        ...
        u'core.indicator': {
            ...
            'form_number': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
