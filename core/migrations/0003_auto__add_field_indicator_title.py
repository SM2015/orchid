...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.title'
        db.add_column(u'core_indicator', 'title',
                      self.gf('django.db.models.fields.CharField')(default='something', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.title'
        db.delete_column(u'core_indicator', 'title')
